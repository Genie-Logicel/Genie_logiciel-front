  ...
  tester = Fake.map((item) => {
    return (
      <div className="portofolio" key={item.id}>
        ...
        <div className="Icon">
          <Link to={item.facebook} className="btn1">
            <FacebookOutlined style={{ fill: "black" }} />
          </Link>
          <Link to={item.gitHub} className="btn1">
            <GitHub style={{ fill: "black" }} />
          </Link>
          <Link to={item.linkedIn} className="btn1">
            <LinkedIn style={{ fill: "black" }} />
          </Link>
          <Link to="/portofolio" className="btn1">
            <HomeOutlined style={{ fill: "#0ef" }} />
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="genie">
      <div className="font" style={backgroundStyle}>
        <h1 className="text-red-600">Qui sommes-nous</h1>
        <p>
