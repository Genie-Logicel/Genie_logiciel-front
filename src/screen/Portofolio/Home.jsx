        ...
        <div className="grid grid-cols-2 px-[10%]">
          <div className="flex items-center">
            <div className="space-y-10">
              <h1 className="mb-4 text-5xl font-extrabold leading-none tracking-tight text-gray-700 md:text-5xl lg:text-6xl">
                Qui sommes-nous
              </h1>
              <p className="text-xl text-gray-600 w-2/3">
                ...
                <div class="md:w-1/4 sm:w-1/2 w-full">
                  <div class="px-4 py-6 flex gap-5 rounded-lg">
                    <svg
                      ...
                      stroke-width="2"
                      class="stroke-blue-500 w-12 mb-3 inline-block"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="flex justify-center items-center">
            <img className="w-[75%]" src="/assets/images/seo-analytics-team-animate.svg" alt=""/>
          </div>
        </div>
      </div>
